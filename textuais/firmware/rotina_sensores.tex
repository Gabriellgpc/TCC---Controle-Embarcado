...
\begin{itemize}
    ...
    \item As etapas seguintes desta seção não usarão a notação de vetor (negrito) para se referir às matrizes do filtro, pois essas matrizes serão tratadas como escaladas.
\end{itemize}
